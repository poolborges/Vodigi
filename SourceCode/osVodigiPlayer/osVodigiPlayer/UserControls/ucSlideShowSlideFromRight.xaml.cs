...
namespace osVodigiPlayer.UserControls
{
    public partial class ucSlideShowSlideFromRight : UserControl
    {
        ...
        public static readonly RoutedEvent SlideShowCompleteEvent = EventManager.RegisterRoutedEvent(
            "SlideShowComplete", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(ucSlideShowSlideFromRight));
        ...
        public ucSlideShowSlideFromRight()
        {
            try
            {
                InitializeComponent();
        ...
        public void ResetControl()
        {
            try
            {
                ...
                // Setup the animation
                daImageOne.From = this.Width + 50;
                daImageOne.To = 0;
                daImageTwo.From = this.Width + 50;
                daImageTwo.To = 0;

                this.Unloaded += ucSlideShowSlideFromRight_Unloaded;
        ...
        void ucSlideShowSlideFromRight_Unloaded(object sender, RoutedEventArgs e)
        {
            try
            {
                mediaPlayer.Stop();
