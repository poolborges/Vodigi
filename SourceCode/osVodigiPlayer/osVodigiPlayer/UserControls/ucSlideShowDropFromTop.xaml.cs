...
{
    public partial class ucSlideShowDropFromTop : UserControl, IPlayController
    {
        // Complete Event
            ...
            try
            {
                if (dsImageURLs != null && dsImageURLs.Count > 0)
                {
                    ...
                    if (imageToDisplay == 1)
                    {
                        ...
                        imgSlideshow1.SetValue(Canvas.TopProperty, Convert.ToDouble(0 - this.Height - 50));
                    ...
                    else
                    {
                        ...
                        imgSlideshow2.SetValue(Canvas.TopProperty, Convert.ToDouble(0 - this.Height - 50));
